...
final class CartInputCaptureSubscriberTest extends TestCase
{
    ...
    public function appliesAllProviderValuesToLineItemPayload(): void
    {
        ...
        self::assertSame('valueA', $lineItem->getPayload()['keyA'] ?? null);
        self::assertSame('valueB', $lineItem->getPayload()['keyB'] ?? null);
        self::assertSame(42, $lineItem->getPayload()['keyC'] ?? null);
    }
